function iz_region_struct = update_iz_neurons_split3_region(iz_region_struct,z2_qq,zx_qq_minus_1,zx_qq_r)
%IZ_UPDATE_V_U Update one subnetwork of the Izhikevich neuron model.
