...
num_non_training_blocks_at_start = 0;
num_non_training_blocks_at_end = 0;
num_training_blocks = num_blocks - num_non_training_blocks_at_start - num_non_training_blocks_at_end;
num_training_repeats = 2;% number of times to repeat each block during training
...
[iz_scalar_consts,iz_matrix_consts,iz_state] = define_iz_neural_network(num_data_dims,num_hdts_dims,'N',N,'internal_weights',sc_data_resized);
