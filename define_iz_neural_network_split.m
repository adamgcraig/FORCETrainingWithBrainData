function [iz_scalar_consts,iz_matrix_consts,iz_state] = define_iz_neural_network_split(num_data_dims,num_hdts_dims,varargin)
...
if any(is_BPhi1_mask)
    BPhi1_mask = values{is_BPhi1_mask};
else
    BPhi1_mask = true(num_data_dims,N);
end
Pinv1_mask = BPhi1_mask'*BPhi1_mask > 0;
...
iz_matrix_consts = struct( ...
    ...
    'BPhi1_mask', BPhi1_mask, ...
    'Pinv1_mask', Pinv1_mask ...
    );
